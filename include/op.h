...
// fill_a 0th idx is the float to fill the first input's entire 2x3 tensor, 1st is backprop grad val
// fill_b 0th idx is the float to fill the second output's entire 2x3 tensor, 1st is backprop grad val
